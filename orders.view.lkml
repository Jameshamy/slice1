view: orders {
  ...
  dimension: analytics_customer_id {
    type: number
    # hidden: yes
    sql: ${TABLE}.analytics_customer_id ;;
  }
  ...
  dimension: fb_flow_id {
    type: string
    sql: ${TABLE}.fb_flow_id ;;
  }
  ...
  dimension: progress_step {
    type: string
    sql: ${TABLE}.progress_step ;;
  }
  ...
  set: detail {
    fields: [
      ...
      delivery_last_name,
      promo_codes.id,
      analytics_customers.id,
      coupons_orders.count,
      faxes.count,
      lhmn_orders.count,
      order_adjustments.count,
      order_approval_scores.count,
      order_transactions.count,
      orders_products.count,
      orders_products_attributes.count,
      ratings.count,
      session_visits.count,
      single_platform_visits.count,
      tickets.count
    ]
  }
}
